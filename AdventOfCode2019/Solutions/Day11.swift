...
//  AdventOfCode2019
//
//  Created by Lukas Capkovic on 10/12/2019.
...
class Day11: Day {
    static let dirs = [(-1,0), (0,1), (1,0), (0,-1)]
    ...
    static func part1(_ input: String) -> String {
        ...
        var map = Array(repeating: Array(repeating: 0, count: 200), count: 200)
        var paintedMap = Array(repeating: Array(repeating: 0, count: 200), count: 200)
        var dirIx = 0
        ...
        while !comp.halted {
            comp.input = [map[cur.0][cur.1]]
            comp.runUntilBlocked()
            map[cur.0][cur.1] = comp.output[0]
            paintedMap[cur.0][cur.1] = 1
            dirIx += comp.output[1] == 0 ? -1 : 1
            comp.output = []
            ...
            cur = (cur.0 + dirs[dirIx].0, cur.1 + dirs[dirIx].1)
        }
        return String(paintedMap.flatMap({ $0 }).reduce(0, +))
    }
    ...
    static func part2(_ input: String) -> String {
        ...
        var paintedMap = Array(repeating: Array(repeating: 0, count: 50), count: 200)
        var dirIx = 0
